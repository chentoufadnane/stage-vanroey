#Variabelen
$rg = Read-Host "Hoe wil je de resource group noemen?" 
...
New-AzResourceGroupDeployment -Name "new-STAC-KV-Key-DES" -ResourceGroupName $rg -TemplateFile "STAC-KV-DES-LAW/Template-1.json" -TemplateParameterFile "STAC-KV-DES-LAW/Template-1.parameters.json"
