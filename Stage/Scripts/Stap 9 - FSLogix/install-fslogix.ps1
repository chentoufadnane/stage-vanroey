...
Copy-item -Force -Recurse 'C:\Windows\PolicyDefinitions\*' -Destination "\\$dcname\SYSVOL\$domain\Policies\PolicyDefinitions"
Copy-item -Force -Recurse 'C:\Windows\PolicyDefinitions\en-US\*' -Destination "\\$dcname\SYSVOL\$domain\Policies\PolicyDefinitions\en-US"