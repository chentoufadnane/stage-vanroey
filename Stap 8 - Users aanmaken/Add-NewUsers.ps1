...
$ADUsers = Import-Csv C:\Temp\user-script.csv -Delimiter ";"
...
Get-ADUser -SearchBase ‘OU=MSTechnics - Administrators,OU=MSTechnics,DC=mstechnics,DC=be’ -Filter * | ForEach-Object {Add-ADGroupMember -Identity ‘Domain Admins’ -Members $_ }
